...
SERVER_KEYSTORE_JKS="kubernetes.master.keystore.jks"
SERVER_KEYSTORE_P12="kubernetes.master.keystore.p12"
SERVER_KEYSTORE_PEM="kubernetes.master.keystore.pem"
SERVER_TRUSTSTORE_JKS="kubernetes.master.truststore.jks"
CLIENT_TRUSTSTORE_JKS="kubernetes.master.truststore.jks"
